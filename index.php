      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 order-1 align-self-end">
            <img src="images/heomap.jpg"  alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
   ...
   <div class="site-section">
      <div class="container">
        <div class="title-section mb-5">
          <h2 class="text-uppercase"><span class="d-block">Một Số</span> Mặt Hàng Mới Nhập</h2>
        </div>
        <div class="row align-items-stretch">
          <div class="col-lg-8">
            <div class="product-item sm-height full-height bg-gray">
              <a href="#" class="product-category">Women <span>25 items</span></a>
              <img src="images/gaubonglongxu.jpg"  alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-4">
